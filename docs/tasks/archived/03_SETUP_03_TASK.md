...
Implemente completamente a tarefa SETUP-03 seguindo `docs/ai/AGENTS.md`, `docs/ai/CONTEXT.md`, `docs/architecture/backend.md`, `docs/architecture/database.md` e este arquivo.

Configure PostgreSQL e Flyway de forma incremental, segura e sem hardcoded secrets. Não implemente autenticação, cadastro, login ou JWT ainda.

Ao final, informe os arquivos criados/alterados e explique como validar que as migrations foram executadas corretamente.
