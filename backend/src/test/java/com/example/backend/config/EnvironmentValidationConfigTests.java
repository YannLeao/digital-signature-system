	...
	void failsWhenRequiredEnvironmentVariablesAreMissing() {
		contextRunner
				...
				.run(context -> assertThat(context)
						...
						.hasMessageContaining("Missing required environment variables: APP_ENV, APP_SECRET, DB_HOST, DB_PORT, DB_NAME, DB_USERNAME, DB_PASSWORD, CORS_ALLOWED_ORIGINS, CORS_ALLOWED_METHODS, CORS_ALLOWED_HEADERS, CORS_ALLOW_CREDENTIALS, CORS_MAX_AGE, WEBAUTHN_RP_ID, WEBAUTHN_RP_NAME, WEBAUTHN_ORIGIN, JWT_PRIVATE_KEY_BASE64, JWT_PUBLIC_KEY_BASE64, JWT_ISSUER, REFRESH_TOKEN_COOKIE_NAME, REFRESH_TOKEN_COOKIE_SECURE, REFRESH_TOKEN_COOKIE_SAME_SITE, REFRESH_TOKEN_COOKIE_PATH, REFRESH_TOKEN_EXPIRATION_DAYS, TOTP_ENCRYPTION_KEY_BASE64, CSRF_COOKIE_NAME, CSRF_HEADER_NAME, CSRF_COOKIE_SECURE, CSRF_COOKIE_SAME_SITE, CSRF_COOKIE_PATH"));
	}
}
